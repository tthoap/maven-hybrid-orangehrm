...
@Slf4j
public class Level_25_DataTest_V_JSON_MultiLevel extends BaseTest {
    ...
    public void beforeClass(String browserName, String appURL) {
        ...
        employeeData = Product.getProduct();
